    ...
    <div class="w3-container w3-round-xxlarge w3-display-middle w3-card-4 w3-third " style="">
        <form class="w3-container w3-white" action="../Controller/Navegacao.php" method="post">
            <div class="w3-section">
                ...
                <input class="w3-input w3-border" type="password" placeholder="Digite a Senha" name="txtSenha">
                <button name="btnCadastrar" class="w3-button w3-block w3-blue w3-section w3-padding"
                    type="submit">Criar conta</button>
                <button name="btnVoltarLogin" class="w3-button w3-block w3-blue w3-section w3-padding"
